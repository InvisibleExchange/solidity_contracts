...
contract PedersenHashNaive {
    ...
    function hash(uint256 a, uint256 b) external returns (uint256) {
        ...
        uint256 fz;
        {
            (uint256 flowX, uint256 flowY, uint256 flowZ) = EllipticCurve
                .jacMul(a & LOW_MASK, P0_X, P0_Y, 1, ALPHA, FIELD_PRIME);
            (uint256 fhighX, uint256 fhighY, uint256 fhighZ) = EllipticCurve
                .jacMul(a >> 248, P1_X, P1_Y, 1, ALPHA, FIELD_PRIME);
        ...
        uint256 sz;
        {
            (uint256 slowX, uint256 slowY, uint256 slowZ) = EllipticCurve
                .jacMul(b & LOW_MASK, P2_X, P2_Y, 1, ALPHA, FIELD_PRIME);
            (uint256 shighX, uint256 shighY, uint256 shighZ) = EllipticCurve
                .jacMul(b >> 248, P3_X, P3_Y, 1, ALPHA, FIELD_PRIME);
