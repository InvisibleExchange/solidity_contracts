...
//     function withdrawERC20(address tokenAddress, address _recipient) private {
//         address vaultAddress = getAssetVaultAddress(tokenAddress);
//         IAssetVault vault = IAssetVault(vaultAddress);

//         uint256 gasFee = gasRequiredForErcWithdrawal();
//         // let tokenPrice = ...
//         // let ethPrice = ...
//         // let ercGasFee = gasFee * ethPrice / tokenPrice;
//         // TODO: Convert to the relevant token amount

//         vault.makeErc20VaultWithdrawal(tokenAddress, _recipient, gasFee);
...
//     function withdrawETH(address _recipient) private {
//         address vaultAddress = getETHVaultAddress();
//         IETHVault vault = IETHVault(vaultAddress);

//         // uint256 withdrawableAmount = vault.getWithdrawableAmount(_recipient);
//         uint256 gasFee = gasRequiredForETHWithdrawal();

//         vault.makeETHVaultWithdrawal(payable(_recipient), gasFee);
...
//     function gasRequiredForETHWithdrawal() internal view returns (uint256) {
...
//     function gasRequiredForERCWithdrawal() internal view returns (uint256) {
